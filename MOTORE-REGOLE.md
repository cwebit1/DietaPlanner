...
1. I vincoli di sicurezza e del nutrizionista (allergie, intolleranze, profilo e blocchi) prevalgono sempre.
2. Le scelte esplicite dell'utente hanno precedenza sulla generazione, purché compatibili con i vincoli del nutrizionista.
3. I controlli offerti dal Set devono essere trattati come preferenze dell'utente compatibili con il percorso alimentare.
4. La guida/PDF completa soltanto ciò che l'utente non ha definito.
5. Preferenze, esclusioni, rotazione e varietà si applicano solo agli spazi rimasti liberi e non possono cancellare una scelta esplicita dell'utente.
6. La ricetta è l'ultimo livello: prima si determina cosa deve contenere il pasto, poi si cerca come realizzarlo.
